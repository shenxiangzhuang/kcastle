...
pub(crate) struct TrajectoryPalette {
    ...
    pub(crate) hover: Hsla,
    pub(crate) primary: Hsla,
    pub(crate) system_foreground: Hsla,
...
pub(crate) mod metrics {
    ...
    pub(crate) const DETAILS_HEADER_HEIGHT: f32 = 42.0;
...
pub(crate) fn trajectory_palette(cx: &App) -> TrajectoryPalette {
    if cx.theme().is_dark() {
        TrajectoryPalette {
            ...
            system_foreground: rgb(0xadb2b8).into(),
            user_foreground: rgb(0x679efe).into(),
            context_foreground: rgb(0x72b694).into(),
        ...
        TrajectoryPalette {
            ...
            system_foreground: rgb(0x81858c).into(),
            user_foreground: rgb(0x4176e6).into(),
            context_foreground: rgb(0x5ca87f).into(),
